...
# load models
model = load_model("Emotion_Model_aug.h5")
...
def main():
    side_img = Image.open("images/emotion4.jpg")
    with st.sidebar:
        st.image(side_img, width=300)
    st.sidebar.subheader("Menu")
    website_menu = st.sidebar.selectbox("Menu", ("Emotion Recognition", "Dataset Details"))
    ...
    elif website_menu == "Dataset Details":
        import pandas as pd
